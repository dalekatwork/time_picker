...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Time Picker'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          Align(
              child: Padding(
            padding: const EdgeInsets.fromLTRB(104.0, 0, 16.0, 16.0),
            child: TimePicker(fetchValues: _fetchValues),
          )),
          Column(children: <Widget>[
            Padding(
                padding: const EdgeInsets.all(16.0),
                child: Text('Time Selected: ${_fetchDisplayTime()}',
